...
class FeedbackResourceTest(OppiaTestCase):
    ...
    valid_course_valid_feedback_url = reverse('quiz:feedback_results_download',
                                        args=[183, 65323])
    invalid_course_valid_feedback_url = reverse('quiz:feedback_results_download',
                                        args=[0, 65323])
    valid_course_invalid_feedback_url = reverse('quiz:feedback_results_download',
                                        args=[183, 0])
    invalid_course_invalid_feedback_url = reverse('quiz:feedback_results_download',
                                        args=[0, 0])
    course_feedback_mismatch_url = reverse('quiz:feedback_results_download',
                                        args=[1, 65323])
    ...
    def test_coursed_feedback_mismatch(self):
        users = [self.admin_user,
                 self.staff_user,
                 self.teacher_user,
                 self.normal_user]
