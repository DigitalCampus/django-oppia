...
3 Users
User A
course-v1 - page 1v1, page 2v1 completed, quiz 1v1 attempted twice, feedback 1v1 completed
    expected: total_activity - 5, completed_activities - 3, total_activity_current - 5, total_activity_previous - 0
course-v2 - page 1v2, page 2v1 completed, quiz 1v2 passed, page 4v1 completed
    expected: total_activity - 9, completed_activities - 5, total_activity_current - 6, total_activity_previous - 3
course-v3 - page 3v1 completed, feedback 1v2 completed
    expected: total_activity - 11, completed_activities - 4, total_activity_current - 5 total_activity_previous - 6 

User B
course-v1 - no activity
    expected: total_activity - 0, completed_activities - 0, total_activity_current - 0, total_activity_previous - 0 
course-v2 - p1v2 completed twice, quiz1v2 complete (passed)
    expected: total_activity - 3, completed_activities - 2, total_activity_current - 3, total_activity_previous - 0
course-v3 - page2v1 complete, feedback 1v2 complete, quiz 1v3 passed
    expected: total_activity - 6, completed_activities - 4, total_activity_current - 5, total_activity_previous - 1
...
course-v2 - no activity
    expected: total_activity - 0, completed_activities - 0, total_activity_current - 0, total_activity_previous - 0 
course-v3 - page 1v2 twice, page 2v1, quiz 1v3 passed
    expected: total_activity - 4, completed_activities - 3, total_activity_current - 4, total_activity_previous - 0
...
class UserCourseSummaryTestCourseV3(OppiaTestCase):
    ...
    test each with and without course version info existing in trackers
    run on incremental updates and also on fromstart - exactly the same expected
    output for each
    '''