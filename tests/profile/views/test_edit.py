...
class EditProfileViewTest(TestCase):
    ...
    def test_edit_own_profile_admin(self):
        orig_org = User.objects.get(username=self.admin_user['user']).userprofile.organisation
        ...
        new_org = User.objects.get(username=self.admin_user['user']).userprofile.organisation
        self.assertNotEqual(orig_org,new_org)
    
    def test_edit_own_profile_staff(self):
        orig_org = User.objects.get(username=self.staff_user['user']).userprofile.organisation
        new_org = 'my organisation'
        self.client.login(username=self.staff_user['user'], password=self.staff_user['password'])
        post_data = {'organisation': new_org,
                     'email': 'admin@me.com',
        ...
        new_org = User.objects.get(username=self.staff_user['user']).userprofile.organisation
        self.assertNotEqual(orig_org,new_org)
        
    def test_edit_own_profile_teacher(self):
        orig_org = User.objects.get(username=self.teacher_user['user']).userprofile.organisation
        new_org = 'my organisation'
        self.client.login(username=self.teacher_user['user'], password=self.teacher_user['password'])
        post_data = {'organisation': new_org,
                     'email': 'admin@me.com',
        ...
        new_org = User.objects.get(username=self.teacher_user['user']).userprofile.organisation
        self.assertNotEqual(orig_org,new_org)
    
    def test_edit_own_profile_user(self):
        orig_org = User.objects.get(username=self.normal_user['user']).userprofile.organisation
        new_org = 'my organisation'
        self.client.login(username=self.normal_user['user'], password=self.normal_user['password'])
        post_data = {'organisation': new_org,
                     'email': 'admin@me.com',
        ...
        new_org = User.objects.get(username=self.normal_user['user']).userprofile.organisation
        self.assertNotEqual(orig_org,new_org)
    ...
    def test_edit_own_password_admin(self):
        ...
        self.client.login(username=self.admin_user['user'], password='newpassword')
        response = self.client.get(reverse('profile_edit'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_own_password_staff(self):
        ...
        self.client.login(username=self.staff_user['user'], password='newpassword')
        response = self.client.get(reverse('profile_edit'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_own_password_teacher(self):
        ...
        self.client.login(username=self.teacher_user['user'], password='newpassword')
        response = self.client.get(reverse('profile_edit'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_edit_own_password_user(self):
        ...
        self.client.login(username=self.normal_user['user'], password='newpassword')
        response = self.client.get(reverse('profile_edit'))
        self.assertEqual(response.status_code, 200)
