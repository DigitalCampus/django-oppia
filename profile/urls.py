...
urlpatterns = [
    ...
    path('reset/', profile_views.ResetView.as_view(), name="reset"),
    path('reset/sent/',
    ...
    path('edit/<int:user_id>/',
         profile_views.EditView.as_view(),
         name="edit_user"),
    ...
    path('<int:user_id>/<int:course_id>/feedback/<int:quiz_id>/responses/<int:pk>',
         profile_views.FeedbackResponseDetail.as_view(),
