...
urlpatterns = [
    ...
    path('logout/', django_contrib_auth_views.LogoutView.as_view(), {'template_name': 'oppia/logout.html', }, name="logout"),
    ...
    path('<int:user_id>/feedback/', profile_views.UserFeedbackResponsesList.as_view(), name="user_all_feedback_responses"),
    path('<int:user_id>/regeneratecertificates/', profile_views.RegenerateCertificatesView.as_view(), name="user_regenerate_certificates"),
    path('<int:user_id>/regeneratecertificates/success/', TemplateView.as_view(template_name="profile/certificates/success.html"), name="user_regenerate_certificates_success"),

    path('regeneratecertificates/', profile_views.RegenerateCertificatesView.as_view(),  name="user_regenerate_certificates"),
    path('regeneratecertificates/success/', TemplateView.as_view( template_name="profile/certificates/success.html"), name="user_regenerate_certificates_success"),
