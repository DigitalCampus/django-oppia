...
urlpatterns = [
    ...
    url(r'^logout/$',
        ...
        name="profile_logout"),
    url(r'^setlang/$',
        django_views_i18n.set_language,
        name="profile_set_language"),
    url(r'^reset/$',
        oppia_profile_views.reset,
        name="profile_reset"),
    url(r'^reset/sent/$',
        TemplateView.as_view(template_name="profile/reset-sent.html"),
        name="profile_reset_sent"),
    url(r'^edit/$',
        oppia_profile_views.edit,
        name="profile_edit"),
    url(r'^edit/(?P<user_id>\d+)/$',
        oppia_profile_views.edit,
        name="profile_edit_user"),
    url(r'^points/$',
        oppia_profile_views.points,
        name="profile_points"),
    url(r'^badges/$',
        oppia_profile_views.badges,
        name="profile_badges"),
    url(r'^(?P<user_id>\d+)/activity/$',
        oppia_profile_views.user_activity,
        name="profile_user_activity"),
    url(r'^(?P<user_id>\d+)/(?P<course_id>\d+)/activity/$',
    ...
    url(r'^(?P<user_id>\d+)/(?P<course_id>\d+)/quiz/(?P<quiz_id>\d+)/attempts/(?P<pk>\d+)$',
        oppia_profile_views.QuizAttemptDetail.as_view(),
    ...
    url(r'^search/$',
        ...
        name="profile_search_users"),
    url(r'^export/$',
        oppia_profile_views.export_users,
        name="profile_export"),
    url(r'^list/$',
        oppia_profile_views.list_users,
        name="profile_list_users"),

    url(r'^delete/$',
        oppia_profile_views.delete_account_view,
        name="profile_delete_account"),
    url(r'^delete/complete/$',
        oppia_profile_views.delete_account_complete_view,
        name="profile_delete_account_complete"),
    url(r'^export/mydata/(?P<data_type>\w[\w/-]*)$',
        oppia_profile_views.export_mydata_view,
        name="profile_export_mydata"),
]
