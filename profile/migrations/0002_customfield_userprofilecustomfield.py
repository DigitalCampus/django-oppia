    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('helper_text', models.TextField(blank=True, default=None, null=True)),
                ('type', models.CharField(choices=[('str', 'String'), ('int', 'Integer'), ('bool', 'Boolean')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('key_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profile.CustomField')),
