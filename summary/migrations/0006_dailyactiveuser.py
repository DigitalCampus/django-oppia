    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('submitted', 'submitted'), ('tracker', 'tracker')], max_length=20)),
                ('dau', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='summary.DailyActiveUsers')),
