...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tracker.section_title'
        db.add_column(u'oppia_tracker', 'section_title',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tracker.section_title'
        db.delete_column(u'oppia_tracker', 'section_title')
