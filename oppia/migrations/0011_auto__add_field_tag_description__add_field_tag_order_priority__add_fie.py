...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'oppia_tag', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tag.order_priority'
        db.add_column(u'oppia_tag', 'order_priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Tag.highlight'
        db.add_column(u'oppia_tag', 'highlight',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Tag.icon'
        db.add_column(u'oppia_tag', 'icon',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'oppia_tag', 'description')

        # Deleting field 'Tag.order_priority'
        db.delete_column(u'oppia_tag', 'order_priority')

        # Deleting field 'Tag.highlight'
        db.delete_column(u'oppia_tag', 'highlight')

        # Deleting field 'Tag.icon'
        db.delete_column(u'oppia_tag', 'icon')
    ...
    models = {
        ...
        u'oppia.tag': {
            ...
            'icon': ('django.db.models.fields.files.FileField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.TextField', [], {}),
