...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'oppia_activity', 'content', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Activity.image'
        db.alter_column(u'oppia_activity', 'image', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Activity.description'
        db.alter_column(u'oppia_activity', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Activity.content'
        db.alter_column(u'oppia_activity', 'content', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Activity.image'
        db.alter_column(u'oppia_activity', 'image', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Activity.description'
        db.alter_column(u'oppia_activity', 'description', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'oppia.activity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
