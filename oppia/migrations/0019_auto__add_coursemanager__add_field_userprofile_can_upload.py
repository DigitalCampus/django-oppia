...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'oppia_coursemanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oppia.Course'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'oppia', ['CourseManager'])

        # Adding field 'UserProfile.can_upload'
        db.add_column(u'oppia_userprofile', 'can_upload',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'oppia_coursemanager')

        # Deleting field 'UserProfile.can_upload'
        db.delete_column(u'oppia_userprofile', 'can_upload')
    ...
    models = {
        ...
        u'oppia.coursemanager': {
            'Meta': {'object_name': 'CourseManager'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['oppia.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        ...
        u'oppia.userprofile': {
            ...
            'phone_number': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
