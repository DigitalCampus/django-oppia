...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'oppia_coursedownload', (
            ...
            ('ip', self.gf('django.db.models.fields.IPAddressField')(default=None, max_length=15, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('agent', self.gf('django.db.models.fields.TextField')(default=None, blank=True)),
        ))
