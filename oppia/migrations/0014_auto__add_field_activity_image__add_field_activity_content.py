...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'oppia_activity', 'image',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Activity.content'
        db.add_column(u'oppia_activity', 'content',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'oppia_activity', 'image')

        # Deleting field 'Activity.content'
        db.delete_column(u'oppia_activity', 'content')
    ...
    models = {
        ...
        u'oppia.activity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'default': 'None', 'blank': 'True'}),
