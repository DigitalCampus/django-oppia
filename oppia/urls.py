...
urlpatterns = [
    ...
    path('course/<int:course_id>/exports/trackers/', views.ExportCourseTrackers.as_view(), name="export_course_trackers"),
    ...
    path('course/<int:course_id>/feedback/<int:feedback_id>/responses/', views.CourseFeedbackResponsesList.as_view(), name="course_feedback_responses"),
    path('course/<int:course_id>/feedback/<int:quiz_id>/responses/<int:pk>', views.FeedbackResponseDetail.as_view(), name="feedback_response_detail"),
