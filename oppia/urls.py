...
urlpatterns = patterns('',
    ...
    url(r'^cohorts/$', 'oppia.views.cohort', name="oppia_cohorts"),
    url(r'^cohorts/add/$', 'oppia.views.cohort_add', name="oppia_cohort_add"),
    url(r'^cohorts/(?P<cohort_id>\d+)/edit/$', 'oppia.views.cohort_edit', name="oppia_cohort_edit"),
    url(r'^cohorts/(?P<cohort_id>\d+)/view/$', 'oppia.views.cohort_view', name="oppia_cohort_view"),
