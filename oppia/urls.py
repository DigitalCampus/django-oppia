...
urlpatterns = [
    ...
    path('cohort/<int:cohort_id>/edit/', views.cohort_edit, name="cohort_edit"),
    path('cohort/<int:cohort_id>/view/', views.cohort_view, name="cohort_view"),
    path('cohort/<int:cohort_id>/<int:course_id>/view/', views.cohort_course_view, name="cohort_course_view"),
    path('cohort/<int:cohort_id>/leaderboard', views.cohort_leaderboard_view, name="cohort_leaderboard"),

    path('view/', views.app_launch_activity_redirect_view, name="app_launch_activity_redirect"),
