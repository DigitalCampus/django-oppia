...
urlpatterns = [
    ...
    path('course/<int:course_id>/feedback/',
         views.CourseFeedbackActivitiesList.as_view(),
    ...
    path('cohort/<int:pk>/edit/',
         views.CohortEditView.as_view(),
         name="cohort_edit"),
    path('cohort/<int:pk>/view/',
