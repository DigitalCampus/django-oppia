    ...
    def handle(self, *args, **options):
        ...
        with open(options['file'], 'rb') as csvfile:
            ...
            for counter, row in enumerate(file_reader):
                ...
                if row[INPUT_FORMAT['qar_id']] == 'QARID' \
                  or row[INPUT_FORMAT['qar_id']] == '' \
                  or row[INPUT_FORMAT['qar_id']] is None:
                    continue
                ...
                if row[INPUT_FORMAT['revised_score']] == '' \
                        or row[INPUT_FORMAT['revised_score']] is None \
                        or row[INPUT_FORMAT['revised_score']] == row[INPUT_FORMAT['score']]:
                    continue
                ...
                new_quiz_score = QuizAttemptResponse.objects \
                    .filter(quizattempt=qar.quizattempt) \
                    .aggregate(new_score=Sum('score'))
                ...
                if quiz_score_percent >= quiz_threshold:
                    ...
                    try:
                        tracker = Tracker.objects.get(user=quiz_attempt.user,
